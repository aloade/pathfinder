...
- Combat ( attaques )
    ...
    - revoir le calcul des critiques, lancé de jet d'attaque :
        ...
        2. ( CA adverse <= jet d'attaque n°1 < critique de l'arme <= 20 ) -> dégâts normaux
        3. ( jet d'attaque n°1 >= critique de l'arme ) ou ( jet d'attaque n°1 = 20 ) -> nouveau lancé de jet d'attaque :
